...
### Added
- Local Server Fallback: Support for running YouTubeKit-Server locally as a fallback when YouTube API changes break local extraction
- Enhanced Documentation: Added setup instructions for local YouTubeKit-Server integration
